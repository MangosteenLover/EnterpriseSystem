...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif' data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-30" data-genuitec-path="/rlzy/WebRoot/admin/yuangong/yuangongAdd.jsp">
			<form action="<%=path %>/yuangong?type=yuangongAdd" name="formAdd" method="post" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-30" data-genuitec-path="/rlzy/WebRoot/admin/yuangong/yuangongAdd.jsp">
