...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif' data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/rlzy/WebRoot/admin/gongzi/gongziAdd.jsp">
			<form action="<%=path %>/gongzi?type=gongziAdd" name="formAdd" method="post" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/rlzy/WebRoot/admin/gongzi/gongziAdd.jsp">
